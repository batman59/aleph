...
APP_TITLE = env.get("ALEPH_APP_TITLE", lazy_gettext("Databrain"))
APP_NAME = env.get("ALEPH_APP_NAME", "databrain")
...
MAIL_FROM = env.get("ALEPH_MAIL_FROM", "admin@braintech-solutions.com")
MAIL_SERVER = env.get("ALEPH_MAIL_HOST", "smtp.1und1.de")
MAIL_USERNAME = env.get("admin@braintech-solutions.com")
MAIL_PASSWORD = env.get("Admintech@432")
MAIL_USE_SSL = env.to_bool("ALEPH_MAIL_SSL", False)
MAIL_USE_TLS = env.to_bool("ALEPH_MAIL_TLS", True)
MAIL_PORT = env.to_int("ALEPH_MAIL_PORT", 587)
